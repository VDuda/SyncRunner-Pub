...
@XmlRootElement(name = "shielding_type")
public class ShieldingType {

    protected List<ShieldingType.Value> value;
     ...
     * {@link ShieldingType.Value }
     * 
     * 
     */
    public List<ShieldingType.Value> getValue() {
        if (value == null) {
            value = new ArrayList<ShieldingType.Value>();
        }
        return this.value;
    }
