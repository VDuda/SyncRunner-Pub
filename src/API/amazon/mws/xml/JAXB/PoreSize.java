...
@XmlRootElement(name = "pore_size")
public class PoreSize {

    protected List<PoreSize.Value> value;
     ...
     * 
     */
    public List<PoreSize.Value> getValue() {
        if (value == null) {
            value = new ArrayList<PoreSize.Value>();
        }
        return this.value;
    }
