...
@XmlRootElement(name = "cfm_at_90_psi")
public class CfmAt90Psi {

    protected CfmAt90Psi.Value value;
     ...
     * @return
     *     possible object is
     *     {@link CfmAt90Psi.Value }
     *     
     */
    public CfmAt90Psi.Value getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CfmAt90Psi.Value value) {
        this.value = value;
    }
