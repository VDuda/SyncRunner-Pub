...
@XmlRootElement(name = "pitch_circle_diameter")
public class PitchCircleDiameter {

    protected List<PitchCircleDiameter.Value> value;
     ...
     * {@link PitchCircleDiameter.Value }
     * 
     * 
     */
    public List<PitchCircleDiameter.Value> getValue() {
        if (value == null) {
            value = new ArrayList<PitchCircleDiameter.Value>();
        }
        return this.value;
    }
