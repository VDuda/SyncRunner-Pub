...
@XmlRootElement(name = "fastener_thread_count")
public class FastenerThreadCount {

    protected FastenerThreadCount.Value value;
     ...
     * @return
     *     possible object is
     *     {@link FastenerThreadCount.Value }
     *     
     */
    public FastenerThreadCount.Value getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(FastenerThreadCount.Value value) {
        this.value = value;
    }
