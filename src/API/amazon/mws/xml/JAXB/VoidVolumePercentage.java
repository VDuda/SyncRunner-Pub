...
@XmlRootElement(name = "void_volume_percentage")
public class VoidVolumePercentage {

    protected List<VoidVolumePercentage.Value> value;
     ...
     * {@link VoidVolumePercentage.Value }
     * 
     * 
     */
    public List<VoidVolumePercentage.Value> getValue() {
        if (value == null) {
            value = new ArrayList<VoidVolumePercentage.Value>();
        }
        return this.value;
    }
