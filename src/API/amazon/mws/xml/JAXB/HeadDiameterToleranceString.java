...
@XmlRootElement(name = "head_diameter_tolerance_string")
public class HeadDiameterToleranceString {

    protected List<HeadDiameterToleranceString.Value> value;
     ...
     * {@link HeadDiameterToleranceString.Value }
     * 
     * 
     */
    public List<HeadDiameterToleranceString.Value> getValue() {
        if (value == null) {
            value = new ArrayList<HeadDiameterToleranceString.Value>();
        }
        return this.value;
    }
