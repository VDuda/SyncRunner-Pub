...
@XmlRootElement(name = "connector_type")
public class ConnectorType {

    @XmlElement(required = true)
    protected ConnectorType.Value value;
     ...
     *     
     */
    public ConnectorType.Value getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(ConnectorType.Value value) {
        this.value = value;
    }
