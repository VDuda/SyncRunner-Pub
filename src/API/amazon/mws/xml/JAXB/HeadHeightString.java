...
@XmlRootElement(name = "head_height_string")
public class HeadHeightString {

    protected List<HeadHeightString.Value> value;
     ...
     * {@link HeadHeightString.Value }
     * 
     * 
     */
    public List<HeadHeightString.Value> getValue() {
        if (value == null) {
            value = new ArrayList<HeadHeightString.Value>();
        }
        return this.value;
    }
