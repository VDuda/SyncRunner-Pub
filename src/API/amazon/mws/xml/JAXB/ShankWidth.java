...
@XmlRootElement(name = "shank_width")
public class ShankWidth {

    protected List<ShankWidth.Value> value;
     ...
     * {@link ShankWidth.Value }
     * 
     * 
     */
    public List<ShankWidth.Value> getValue() {
        if (value == null) {
            value = new ArrayList<ShankWidth.Value>();
        }
        return this.value;
    }
