...
@XmlRootElement(name = "drum_capacity")
public class DrumCapacity {

    protected List<DrumCapacity.Value> value;
     ...
     * {@link DrumCapacity.Value }
     * 
     * 
     */
    public List<DrumCapacity.Value> getValue() {
        if (value == null) {
            value = new ArrayList<DrumCapacity.Value>();
        }
        return this.value;
    }
