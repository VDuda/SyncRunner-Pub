 ...
 *       &lt;sequence>
 *         &lt;element name="value" maxOccurs="7" minOccurs="0">
 *           &lt;complexType>
 *             &lt;simpleContent>
...
@XmlRootElement(name = "shank_height")
public class ShankHeight {

    protected List<ShankHeight.Value> value;
     ...
     * {@link ShankHeight.Value }
     * 
     * 
     */
    public List<ShankHeight.Value> getValue() {
        if (value == null) {
            value = new ArrayList<ShankHeight.Value>();
        }
        return this.value;
    }
