...
@XmlRootElement(name = "item_length_tolerance_string")
public class ItemLengthToleranceString {

    protected List<ItemLengthToleranceString.Value> value;
     ...
     * {@link ItemLengthToleranceString.Value }
     * 
     * 
     */
    public List<ItemLengthToleranceString.Value> getValue() {
        if (value == null) {
            value = new ArrayList<ItemLengthToleranceString.Value>();
        }
        return this.value;
    }
