...
@XmlRootElement(name = "maximum_shaft_penetration")
public class MaximumShaftPenetration {

    protected List<MaximumShaftPenetration.Value> value;
     ...
     * {@link MaximumShaftPenetration.Value }
     * 
     * 
     */
    public List<MaximumShaftPenetration.Value> getValue() {
        if (value == null) {
            value = new ArrayList<MaximumShaftPenetration.Value>();
        }
        return this.value;
    }
