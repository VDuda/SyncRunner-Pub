...
@XmlRootElement(name = "plug_size")
public class PlugSize {

    @XmlElement(required = true)
    protected PlugSize.Value value;
     ...
     *     
     */
    public PlugSize.Value getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(PlugSize.Value value) {
        this.value = value;
    }
