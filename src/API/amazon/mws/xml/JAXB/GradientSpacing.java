...
@XmlRootElement(name = "gradient_spacing")
public class GradientSpacing {

    protected List<GradientSpacing.Value> value;
     ...
     * {@link GradientSpacing.Value }
     * 
     * 
     */
    public List<GradientSpacing.Value> getValue() {
        if (value == null) {
            value = new ArrayList<GradientSpacing.Value>();
        }
        return this.value;
    }
