...
package API.amazon.mws.orders.mock;
...
public  class MarketplaceWebServiceOrdersMock implements MarketplaceWebServiceOrders {
    ...
    static {
        try {
            jaxbContext = JAXBContext.newInstance("com.amazonservices.mws.orders.model", MarketplaceWebServiceOrders.class.getClassLoader());
