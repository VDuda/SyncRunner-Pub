...
public class ListOrdersByNextTokenSample {
    ...
    public static void main(String... args) {
         ...
         * sample for List Orders By Next Token 
         ***********************************************************************/
        ...
        try {
            ...
            if (response.isSetListOrdersByNextTokenResult()) {
                ...
                if (listOrdersByNextTokenResult.isSetNextToken()) {
                    ...
                    System.out.println();
                    System.out.println("                " + listOrdersByNextTokenResult.getNextToken());
                    System.out.println();
                }
                if (listOrdersByNextTokenResult.isSetCreatedBefore()) {
                    System.out.println("            CreatedBefore");
                    System.out.println();
                    System.out.println("                " + listOrdersByNextTokenResult.getCreatedBefore());
                    System.out.println();
                }
                if (listOrdersByNextTokenResult.isSetLastUpdatedBefore()) {
                    System.out.println("            LastUpdatedBefore");
                    System.out.println();
                    System.out.println("                " + listOrdersByNextTokenResult.getLastUpdatedBefore());
                    System.out.println();
                }
