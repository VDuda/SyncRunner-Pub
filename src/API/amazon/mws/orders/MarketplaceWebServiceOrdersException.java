...
public class MarketplaceWebServiceOrdersException extends Exception {
     ...
     */
    public MarketplaceWebServiceOrdersException(String message, int statusCode, String errorCode, String errorType, String requestId,  String xml, ResponseHeaderMetadata metadata) {
