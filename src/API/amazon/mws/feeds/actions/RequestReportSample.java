...
import API.amazon.mws.feeds.model.RequestReportResult;
...
public class RequestReportSample {
    ...
    public static void main(String... args) {
         ...
         * http://aws.amazon.com
         ***********************************************************************/
        final String accessKeyId = FeedsConfig.getAccessKeyId();
        final String secretAccessKey = FeedsConfig.getSecretAccessKey();

        final String appName = FeedsConfig.getApplicationName();
        final String appVersion = FeedsConfig.getApplicationVersion();
         ...
         ***********************************************************************/
        final String merchantId = FeedsConfig.getSellerId();
        // marketplaces from which data should be included in the report; look at the
        // API reference document on the MWS website to see which marketplaces are
        // included if you do not specify the list yourself
        final IdList marketplaces = new IdList(Arrays.asList(
        		FeedsConfig.getMarketplaceId()));
