...
package API.amazon.mws.feeds.service;
...
import API.amazon.mws.feeds.model.CancelFeedSubmissionsRequest;
import API.amazon.mws.feeds.model.CancelFeedSubmissionsResponse;
import API.amazon.mws.feeds.model.CancelReportRequestsRequest;
import API.amazon.mws.feeds.model.CancelReportRequestsResponse;
import API.amazon.mws.feeds.model.ErrorResponse;
import API.amazon.mws.feeds.model.GetFeedSubmissionCountRequest;
import API.amazon.mws.feeds.model.GetFeedSubmissionCountResponse;
import API.amazon.mws.feeds.model.GetFeedSubmissionListByNextTokenRequest;
import API.amazon.mws.feeds.model.GetFeedSubmissionListByNextTokenResponse;
...
import API.amazon.mws.feeds.model.GetFeedSubmissionResultResult;
import API.amazon.mws.feeds.model.GetReportCountRequest;
import API.amazon.mws.feeds.model.GetReportCountResponse;
import API.amazon.mws.feeds.model.GetReportListByNextTokenRequest;
import API.amazon.mws.feeds.model.GetReportListByNextTokenResponse;
...
import API.amazon.mws.feeds.model.GetReportRequestCountRequest;
import API.amazon.mws.feeds.model.GetReportRequestCountResponse;
import API.amazon.mws.feeds.model.GetReportRequestListByNextTokenRequest;
import API.amazon.mws.feeds.model.GetReportRequestListByNextTokenResponse;
...
import API.amazon.mws.feeds.model.GetReportScheduleListByNextTokenRequest;
import API.amazon.mws.feeds.model.GetReportScheduleListByNextTokenResponse;
import API.amazon.mws.feeds.model.GetReportScheduleListRequest;
import API.amazon.mws.feeds.model.GetReportScheduleListResponse;
import API.amazon.mws.feeds.model.IdList;
import API.amazon.mws.feeds.model.ManageReportScheduleRequest;
import API.amazon.mws.feeds.model.ManageReportScheduleResponse;
...
import API.amazon.mws.feeds.model.ResponseHeaderMetadata;
import API.amazon.mws.feeds.model.StatusList;
import API.amazon.mws.feeds.model.SubmitFeedRequest;
import API.amazon.mws.feeds.model.SubmitFeedResponse;
import API.amazon.mws.feeds.model.TypeList;
import API.amazon.mws.feeds.model.UpdateReportAcknowledgementsRequest;
import API.amazon.mws.feeds.model.UpdateReportAcknowledgementsResponse;
...
public  class MarketplaceWebServiceClient implements MarketplaceWebService {
    ...
    static {
        try {
            jaxbContext = JAXBContext.newInstance("API.amazon.mws.feeds.model", MarketplaceWebService.class.getClassLoader());
