...
public class GetMyPriceForASINSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Get My Price For ASIN 
         ***********************************************************************/
    ...
    public static void invokeGetMyPriceForASIN(MarketplaceWebServiceProducts service, GetMyPriceForASINRequest request) {
        try {
            ...
            System.out.println ("GetMyPriceForASIN Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    GetMyPriceForASINResponse");
            System.out.println();
            java.util.List<GetMyPriceForASINResult> getMyPriceForASINResultList = response.getGetMyPriceForASINResult();
            for (GetMyPriceForASINResult getMyPriceForASINResult : getMyPriceForASINResultList) {
                System.out.println("        GetMyPriceForASINResult");
                System.out.println();
            if (getMyPriceForASINResult.isSetASIN()) {
                System.out.println("        ASIN");
                System.out.println();
                System.out.println("            " + getMyPriceForASINResult.getASIN());
                System.out.println();
            } 
            if (getMyPriceForASINResult.isSetStatus()) {
                System.out.println("        status");
                System.out.println();
                System.out.println("            " + getMyPriceForASINResult.getStatus());
                System.out.println();
            } 
                if (getMyPriceForASINResult.isSetProduct()) {
                    System.out.println("            Product");
                    System.out.println();
                    Product  product = getMyPriceForASINResult.getProduct();
                ...
                if (getMyPriceForASINResult.isSetError()) {
                    ...
                    System.out.println();
                    API.amazon.mws.products.model.Error  error = getMyPriceForASINResult.getError();
                    if (error.isSetType()) {
