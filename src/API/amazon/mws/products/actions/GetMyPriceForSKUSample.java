...
public class GetMyPriceForSKUSample {
    ...
    public static void invokeGetMyPriceForSKU(MarketplaceWebServiceProducts service, GetMyPriceForSKURequest request) {
        try {
            ...
            System.out.println ("GetMyPriceForSKU Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    GetMyPriceForSKUResponse");
            System.out.println();
            java.util.List<GetMyPriceForSKUResult> getMyPriceForSKUResultList = response.getGetMyPriceForSKUResult();
            for (GetMyPriceForSKUResult getMyPriceForSKUResult : getMyPriceForSKUResultList) {
                System.out.println("        GetMyPriceForSKUResult");
                System.out.println();
            if (getMyPriceForSKUResult.isSetSellerSKU()) {
                System.out.println("        SellerSKU");
                System.out.println();
                System.out.println("            " + getMyPriceForSKUResult.getSellerSKU());
                System.out.println();
            } 
            if (getMyPriceForSKUResult.isSetStatus()) {
                System.out.println("        status");
                System.out.println();
                System.out.println("            " + getMyPriceForSKUResult.getStatus());
                System.out.println();
            } 
                if (getMyPriceForSKUResult.isSetProduct()) {
                    System.out.println("            Product");
                    System.out.println();
                    Product  product = getMyPriceForSKUResult.getProduct();
                ...
                if (getMyPriceForSKUResult.isSetError()) {
                    ...
                    System.out.println();
                    API.amazon.mws.products.model.Error  error = getMyPriceForSKUResult.getError();
                    if (error.isSetType()) {
